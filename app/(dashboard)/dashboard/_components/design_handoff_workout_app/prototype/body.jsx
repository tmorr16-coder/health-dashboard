...
// Each muscle group fills with the accent color when primary/secondary.
// Hit-detection happens on each muscle path directly (no overlay polygons).
// API: <Body primary={['quads']} secondary={['calves']} view="front" size={220} onMuscleClick={(g)=>...} />
//
// Coords: 1000-wide viewBox per view. Heights tuned per view.
//   Front: 1000 × 2500 (aspect 0.40)
//   Back:  1000 × 2500 (aspect 0.40)
// All paths are illustrative anatomy — not medical reference. Tuned for a
// medium build at roughly 8-head-tall proportions.

const VIEW_W = 1000;
const VIEW_H = 2500;

// ─── FRONT view ────────────────────────────────────────────────────────────
// Outline silhouette (single closed path tracing the body)
const OUTLINE_FRONT = `
  M 500 40
  C 410 40 350 110 350 230
  C 350 310 380 350 415 380
  L 415 420
  C 360 440 290 480 235 540
  C 195 590 165 660 145 740
  L 115 900
  C 100 980 100 1060 115 1130
  C 125 1180 140 1230 155 1270
  C 165 1300 180 1310 195 1300
  C 205 1295 210 1280 205 1260
  C 195 1210 190 1150 200 1080
  C 215 1000 240 920 270 850
  L 305 770
  C 325 720 350 680 380 660
  C 395 720 400 800 405 870
  C 410 950 410 1030 405 1100
  L 405 1180
  C 395 1240 380 1300 365 1380
  C 345 1500 330 1640 335 1780
  C 340 1900 360 1990 385 2060
  L 385 2310
  C 380 2380 380 2440 390 2470
  L 470 2470
  C 475 2440 475 2390 475 2350
  L 475 2080
  C 490 2020 500 1950 500 1860
  L 500 1180
  C 500 1180 500 1860 500 1860
  C 500 1950 510 2020 525 2080
  L 525 2350
  C 525 2390 525 2440 530 2470
  L 610 2470
  C 620 2440 620 2380 615 2310
  L 615 2060
  C 640 1990 660 1900 665 1780
  C 670 1640 655 1500 635 1380
  C 620 1300 605 1240 595 1180
  L 595 1100
  C 590 1030 590 950 595 870
  C 600 800 605 720 620 660
  C 650 680 675 720 695 770
  L 730 850
  C 760 920 785 1000 800 1080
  C 810 1150 805 1210 795 1260
  C 790 1280 795 1295 805 1300
  C 820 1310 835 1300 845 1270
  C 860 1230 875 1180 885 1130
  C 900 1060 900 980 885 900
  L 855 740
  C 835 660 805 590 765 540
  C 710 480 640 440 585 420
  L 585 380
  C 620 350 650 310 650 230
  C 650 110 590 40 500 40 Z
`;

// Muscles — drawn INSIDE the outline, filled when active.
// Each entry: { g: muscle-group, d: svg-path }
// Groups: chest, shoulders, biceps, forearms, abs, obliques, quads, calves, traps
const MUSCLES_FRONT = [
  // Trapezius (upper, visible above clavicle) — small fan from neck to shoulder
  ...
  // Pectorals — left + right, with sternum gap
  ...
  // Deltoids — 3 visible heads per side (anterior + lateral)
  // Left lateral delt
  ...
  // Rectus abdominis — 8-pack, two columns × four rows, with central linea alba
  // Top row (just below pec line)
  ...
  // Bottom row (V-cut tapering down)
  ...
  // Quadriceps — three heads per leg
  ...
  // Left vastus medialis (inner teardrop, more pronounced near knee)
...
// ─── BACK view ─────────────────────────────────────────────────────────────
const OUTLINE_BACK = OUTLINE_FRONT; // silhouette is symmetric

const MUSCLES_BACK = [
  // Traps — large diamond from base of skull to mid-back
  ...
  // Lats — big V from underarm down to lower back
  ...
  // Forearms (back view — same outline)
  { g: 'forearms', d: 'M 175 870 C 160 910 145 970 135 1030 C 130 1080 135 1130 145 1170 C 165 1175 195 1170 215 1160 C 220 1110 225 1060 230 1010 C 230 950 230 905 225 870 C 210 875 190 875 175 870 Z' },
  { g: 'forearms', d: 'M 825 870 C 840 910 855 970 865 1030 C 870 1080 865 1130 855 1170 C 835 1175 805 1170 785 1160 C 780 1110 775 1060 770 1010 C 770 950 770 905 775 870 C 790 875 810 875 825 870 Z' },

  // Glutes — two rounded hemispheres
  ...
  // Hamstrings — two heads per leg (semitendinosus inner + biceps femoris outer)
  // Left outer hamstring (biceps femoris)
  ...
  // Left inner hamstring (semitendinosus)
  ...
  // Calves (back view) — same as front, two heads each
  { g: 'calves', d: 'M 470 2080 C 460 2140 455 2200 460 2260 C 470 2310 485 2330 500 2330 L 500 2080 Z' },
  { g: 'calves', d: 'M 400 2080 C 395 2140 395 2200 405 2250 C 415 2280 430 2290 445 2280 C 455 2230 460 2170 465 2110 C 460 2090 455 2080 450 2080 Z' },
  { g: 'calves', d: 'M 530 2080 C 540 2140 545 2200 540 2260 C 530 2310 515 2330 500 2330 L 500 2080 Z' },
  { g: 'calves', d: 'M 600 2080 C 605 2140 605 2200 595 2250 C 585 2280 570 2290 555 2280 C 545 2230 540 2170 535 2110 C 540 2090 545 2080 550 2080 Z' },
...
// Wider hit-zones laid invisibly on top so muscles are easy to tap even where
// the rendered path is narrow (e.g. neck-side traps). Uses the same group
// names as the muscle paths.
const HIT_ZONES = {
  front: [
...
const Body = ({ primary = [], secondary = [], view = 'front', size = 220, onMuscleClick, theme = 'light' }) => {
  const isP = g => primary.includes(g);
  const isS = g => secondary.includes(g);

  // Listen for sex changes (kept for future use; visuals are unisex for now)
  const [sex, setSex] = React.useState(() => localStorage.getItem('wa-sex') || 'male');
  React.useEffect(() => {
    const onChange = (e) => setSex(e.detail);
    window.addEventListener('wa-sex-changed', onChange);
    return () => window.removeEventListener('wa-sex-changed', onChange);
  }, []);
  ...
  // Polygon path helper (for hit-zones)
  const toPath = (pts) =>
    'M ' + pts.split(' ').map(p => p.replace(',', ' ')).join(' L ') + ' Z';

  // Female toggle: subtly narrow the figure horizontally to hint at body type
  const sexScale = sex === 'female' ? 'scale(0.92, 1)' : 'none';
  const sexTransform = sex === 'female' ? 'translateX(40px)' : '';
  ...
  return (
    ...
    >
      <defs>
        <radialGradient id="bodyVignette" cx="50%" cy="35%" r="65%">
      ...
      <g style={{ transform: sexScale, transformOrigin: 'center', transformBox: 'view-box' }}>
        {/* Base silhouette fill */}
        <path d={outline} fill="url(#bodyVignette)" stroke={outlineCol} strokeWidth="5" strokeLinejoin="round" />

        {/* Top-light highlight */}
        <path d={outline} fill="url(#bodyHighlight)" stroke="none" />

        {/* Muscle definition layer */}
        {muscles.map((m, i) => {
          const p = isP(m.g), s = isS(m.g);
          const active = p || s;
          return (
            <path
              key={i}
              d={m.d}
              fill={p ? 'var(--accent)' : s ? 'var(--accent-soft)' : skin}
              fillOpacity={p ? 0.85 : s ? 0.6 : 0.5}
              stroke={active ? 'var(--accent)' : muscleLine}
        ...
        {/* Re-stroke the outline on top so muscles don't bleed past the body */}
        <path d={outline} fill="none" stroke={outlineCol} strokeWidth="5" strokeLinejoin="round" />

        {/* Hit-zones (invisible, on top so taps land reliably) */}
        {zones.map((z, i) => (
          <path
            key={`hz-${i}`}
            d={toPath(z.pts)}
            fill="rgba(0,0,0,0.001)"
            onClick={onMuscleClick ? (e) => { e.stopPropagation(); onMuscleClick(z.g); } : undefined}
